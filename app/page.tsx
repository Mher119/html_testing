  ...
  return (
    <main className="min-h-screen bg-[#12171d] text-white pb-20 font-sans">
      ...
      <header className="sticky top-0 z-50 p-3 text-center bg-[#1D5B43] min-h-[92px] md:min-h-[102px] flex flex-col justify-center ">
        <p className="text-[20px] font-medium tracking-tight text-white md:text-[20px]">
        ...
        <div className="flex items-center justify-center gap-2 mt-1">
          ...
          <div
            className={`text-3xl font-bold tracking-tighter tabular-nums ${timeLeft <= 30 && timeLeft > 0 ? "animate-blink-red" : "text-[#FFBB00]"}`}
          >
            {formatTime(timeLeft)}
          </div>
          <span
